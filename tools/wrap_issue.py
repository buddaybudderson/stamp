...
<p style="max-width:820px;margin:-24px auto 40px;padding:0 20px;font:400 11.5px/1.7 'IBM Plex Mono',ui-monospace,monospace;color:var(--ink-3)">This program can be wrong, and has been. Every figure names the file it came from; check one before you act on it, and see <a href="/corrections/" style="color:var(--stamp)">Corrections &amp; changes</a> for what we have already got wrong. An issued document is never edited: if a number here is wrong, the correction is issued under a new date and this page stands as it was.</p>
</body>
</html>
'''.encode()
